...
def commit(
    ...
    exclude_namerecords: t.Optional[t.Tuple[int]] = (),
    ...
    keep_width_elidable: t.Optional[bool] = False,
    keep_weight_elidable: t.Optional[bool] = False,
    super_family: t.Optional[bool] = False,
    alt_uid: t.Optional[bool] = False,
    oblique_not_italic: t.Optional[bool] = False,
    auto_shorten: t.Optional[bool] = True,
    cff: t.Optional[bool] = False,
    output_dir: t.Optional[Path] = None,
    recalc_timestamp: t.Optional[bool] = False,
